...
let pp = await conn.profilePictureUrl(conn.user.jid).catch(_ => 'https://qu.ax/FxWc.jpg')
...
filesDeleted++;
console.log(`⚠️ Eliminacion NilouSession (PreKey) que provocan el undefined el chat`)}}}*/
